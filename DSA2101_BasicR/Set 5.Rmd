...
```{r data, include = TRUE}
artist_info <- read.csv("../DSA2101/artist_data.csv") %>% as_tibble()
artist_work <- read.csv("../DSA2101/artwork_data.csv") %>% as_tibble()
...
#Place of Birth
artists_nation <- read_xlsx("../DSA2101/artists_nation.xlsx")
